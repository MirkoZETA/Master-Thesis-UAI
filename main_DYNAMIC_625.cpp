...
int main(int argc, char* argv[]) {
    ...
    std::vector<std::string> archivosSalida = {
        "./results/NSFNet_CL_625_BestFit.csv",
        "./results/NSFNet_CL_625_FirstFit.csv",
        "./results/EuroCore_CL_625_BestFit.csv",
        "./results/EuroCore_CL_625_FirstFit.csv",
        "./results/UKNet_CL_625_BestFit.csv",
        "./results/UKNet_CL_625_FirstFit.csv",
    };
